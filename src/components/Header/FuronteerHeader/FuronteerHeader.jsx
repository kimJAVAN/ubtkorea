...
import "./furonteer-header-section.css"
import gsap from "gsap";
import ScrollTrigger from 'gsap/scrollTrigger';

export default function FuronteerHeader() {
    ...
    return (
        <header
            className={`furonteer-header-section ${window.scrollY !== 0 ? "chit-header-white" : ""}`}
        ...
        >
            <div className="chit-header-container pc-only">
                <nav className="chit-header-nav pc-only">
                    ...
                    <div className="furonteer-header-empty-div">
