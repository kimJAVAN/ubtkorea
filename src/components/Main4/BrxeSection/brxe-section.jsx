                        ...
                        <div  className="brxe-right">
                            <div className="brxe-text">
                                <div className={"smlet"}>
                                    ...
                                    <p>저희 UBT Korea를 찾아주신 여러분께 진심으로 감사의 말씀을 드립니다. <br/>
                                        UBT Korea는 아직 세상에 널리 알려지지 않은 아름다움을 발견하고, 이를 고객 여러분과 공유하기 위해 설립되었습니다.   </p>

                                    <p className={"white"}> 저희 UBT Korea를 찾아주신 여러분께 진심으로 감사의 말씀을 드립니다.
                                        UBT Korea는 아직 세상에 널리 알려지지 않은 아름다움을 발견하고, 이를 고객 여러분과 공유하기 위해 설립되었습니다.  </p>

                                    <p>UBT Korea는 혁신과 열정을 바탕으로 고객의 기대를 뛰어넘는 제품과 경험을 제공하며, 새로운 아름다움을 함께 만들어 나가겠습니다.

                                    </p>

                                    <p className={"white"}>  앞으로도 많은 관심과 성원을 부탁드리며, 여러분의 일상 속에서 작은 아름다움을 발견할 수 있도록 최선을 다하겠습니다.
                                        감사합니다.
